...
public class MyIndexReader {
	 ...
	 * ...
	 * 
	 * In the returned 2-dimension array, the first dimension is for each document,
	 * and the second dimension records the docid and frequency.
	 * 
	 * For example:
	 * array[0][0] records the docid of the first document the token appears.
	 * array[0][1] records the frequency of the token in the documents with docid =
	 * array[0][0]
	 * ...
	 * 
	 * NOTE that the returned posting list array should be ranked by docid from the
